...
public class DataSourceConfig {
	...
	@Bean
	public DataSourceTransactionManager getPlatformTransactionManager(DataSource dataSource) throws SQLException {
	...
	public ServletRegistrationBean<StatViewServlet> druidStatViewServle() {
		...
		// 白名单
		servletRegistrationBean.addInitParameter("allow", ""); //addInitParameter 127.0.0.1 暂时允许所有访问
		// IP黑名单
		servletRegistrationBean.addInitParameter("deny", "127.0.1.1");
		// 登录查看信息的账号密码.
