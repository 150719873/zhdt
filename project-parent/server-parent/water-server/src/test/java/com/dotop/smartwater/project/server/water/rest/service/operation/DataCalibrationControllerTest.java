...
public class DataCalibrationControllerTest {
	@Autowired
	...
	public void testGet() throws Exception {
		DataCalibrationForm param = new DataCalibrationForm();
		mvc.perform(
				//指定接口
				MockMvcRequestBuilders.post("/dataCalibration/get")
	...
	public void testPage() throws Exception {
		...
		mvc.perform(
				//指定接口
				MockMvcRequestBuilders.post("/dataCalibration/page")
						.contentType(MediaType.APPLICATION_JSON_UTF8_VALUE)
						.content(JSONUtils.toJSONString(param))
				//判定状态
		).andExpect(MockMvcResultMatchers.status().isOk())
	...
	public void testEdit() throws Exception {
		...
		mvc.perform(
				//指定接口
				MockMvcRequestBuilders.post("/dataCalibration/edit")
						.contentType(MediaType.APPLICATION_JSON_UTF8_VALUE)
						.content(JSONUtils.toJSONString(param))
				//判定状态
		).andExpect(MockMvcResultMatchers.status().isOk())
