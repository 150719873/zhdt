...
@Component("OutStorageBuildFactoryImpl")
public class OutStorageBuildFactoryImpl implements IWorkCenterBuildFactory, IAuthCasClient  {

	private final static Logger logger = LogManager.getLogger(OutStorageBuildFactoryImpl.class);
