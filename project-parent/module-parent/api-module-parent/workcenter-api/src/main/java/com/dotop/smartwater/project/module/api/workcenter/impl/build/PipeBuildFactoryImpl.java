...
@Component("PipeBuildFactoryImpl")
public class PipeBuildFactoryImpl implements IWorkCenterBuildFactory {
	private  static final Logger LOGGER = LogManager.getLogger(PipeBuildFactoryImpl.class);
