 ...
 *
 */
@Component("OaBuildFactoryImpl")
public class OaBuildFactoryImpl implements IWorkCenterBuildFactory {

	private  static final Logger LOGGER = LogManager.getLogger(OaBuildFactoryImpl.class);
