...
public class WeixinCouponVo {
	...
	public WeixinCouponVo() {

	}

	public WeixinCouponVo(String tradeSN, String transactionId, String couponBatchId, String couponId, int couponFee) {
