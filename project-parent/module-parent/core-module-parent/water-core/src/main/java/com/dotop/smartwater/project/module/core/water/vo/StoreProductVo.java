...
public class StoreProductVo extends BaseVo {
	
	public static final int PRODUCT_STATUS_DELETE = -1;// 删除
	public static final int PRODUCT_STATUS_DOWN = 0;// 下线
	public static final int PRODUCT_STATUS_SAVE = 1;// 保存
	public static final int PRODUCT_STATUS_UP = 2;// 上线
	...
	private Integer stockTotal ; // 库存数量
