...
public class WrongAccountVo extends BaseVo {
	...
	public void addLadderPrice(String name, BigDecimal amount) {
		if (this.ladderPrices == null) {
			this.ladderPrices = new ArrayList<LadderPriceVo>();
		}
		LadderPriceVo ladderPrice = new LadderPriceVo();
		ladderPrice.setName(name);
		ladderPrice.setAmount(amount);
		this.ladderPrices.add(ladderPrice);
	}

	// @Data
	// class LadderPrice {
	//
	// public LadderPrice(String name, BigDecimal amount) {
	// super();
	// this.name = name;
	// this.amount = amount;
	// }
