...
public class WXPayUtil {
    ...
    public static Map<String, String> requestWechat(String requestUrl, Map<String, String> reqData) {
        ...
        try {
            inputStream = sendPostXMLRequest(requestUrl, mapToXml(reqData));
            resultMap = parseXml(inputStream);
        } catch (Exception e) {
            throw new FrameworkRuntimeException(PayConstants.RESULT_RESPONSE_ERROR_CODE,e.getMessage());
        }
        return resultMap;
    }
}
