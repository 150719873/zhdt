//package com.dotop.pipe.server.socketHandler;
//
...
//
//@Service
//public class PipeSocketHandler extends TextWebSocketHandler {
//	private static final Logger logger = LogManager.getLogger(PipeSocketHandler.class);
//
//	/**
...
//		String id = (String) session.getAttributes().get("WEBSOCKET_CAS");
//		logger.info("用户id:" + id);
//		if (id != null) {
...
//			session.close();
//		}
//		System.out.println("链接出错，关闭链接,异常信息:" + exception.getMessage());
...
//		System.out.println("链接关闭,关闭信息:" + closeStatus.toString());
//		String userId = getUserId(session);
//		if (USERS.get(userId) != null) {
//			USERS.remove(userId);
//		}
