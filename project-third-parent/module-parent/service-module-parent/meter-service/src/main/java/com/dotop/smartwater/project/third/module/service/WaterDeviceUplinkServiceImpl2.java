...
@Service("WaterDeviceUplinkServiceImpl2")
public class WaterDeviceUplinkServiceImpl2 implements IWaterDeviceUplinkService2 {

    private static final Logger LOGGER = LogManager.getLogger(WaterDeviceUplinkServiceImpl2.class);
