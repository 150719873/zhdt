...
@Service("WaterOwnerServiceImpl2")
public class WaterOwnerServiceImpl2 implements IWaterOwnerService2 {

    private static final Logger LOGGER = LogManager.getLogger(WaterOwnerServiceImpl2.class);
