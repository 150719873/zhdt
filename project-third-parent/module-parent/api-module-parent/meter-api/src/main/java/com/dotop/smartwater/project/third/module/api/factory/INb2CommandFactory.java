...
public interface INb2CommandFactory extends IWaterObtainFactory<UserSynForm, UserSynVo> {

    @Override
    UserSynVo sendCommand(UserSynForm userSynForm) throws FrameworkRuntimeException;
}
