...
import com.dotop.smartwater.project.third.module.api.factory.IWaterFactory;
import com.dotop.smartwater.project.third.module.api.service.IWaterDeviceService;
import com.dotop.smartwater.project.third.module.api.service.IWaterDeviceUplinkService2;
import com.dotop.smartwater.project.third.module.api.service.IWaterOwnerService2;
...
public class WaterFactoryImpl implements IWaterFactory {
    ...
    @Resource(name = "WaterDeviceUplinkServiceImpl2")
    IWaterDeviceUplinkService2 iWaterDeviceUplinkService;
    @Autowired
    IWaterDeviceService iWaterDeviceService;
    @Resource(name = "WaterOwnerServiceImpl2")
    private IWaterOwnerService2 waterOwnerService;
