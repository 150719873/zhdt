 ...
 *
 */
public class SetDateCallable extends ConcentratorCallable {

    private final static Logger LOGGER = LogManager.getLogger(SetDateCallable.class);

    public SetDateCallable(String enterpriseid, String taskLogId, String taskType, String concentratorCode, CallableParam callableParam) {
    ...
    public FutureResult call() {
        ...
        try {
            ...
            baseModel.setClock(callableParam.getSetDate());
