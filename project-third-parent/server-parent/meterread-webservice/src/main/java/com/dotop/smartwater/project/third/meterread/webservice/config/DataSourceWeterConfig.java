...
//数据库配置
@Configuration
@MapperScan(basePackages = {"com.dotop.smartwater.project.third.meterread.webservice.dao"}, sqlSessionTemplateRef = "waterSqlSessionTemplate")
public class DataSourceWeterConfig {
    ...
    public SqlSessionFactory waterSqlSessionFactory(@Qualifier("waterData") DataSource dataSource) throws Exception {
        ...
        bean.setMapperLocations(new PathMatchingResourcePatternResolver().getResources("classpath*:com/dotop/smartwater/project/third/meterread/webservice/dao/**/*.xml"));
