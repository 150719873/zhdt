...
//数据库配置
@Configuration
@MapperScan(basePackages = {"com.dotop.smartwater.project.third.server.meterread.client3.dao.third"}, sqlSessionTemplateRef = "thirdSqlSessionTemplate")
public class DataSourceThirdConfig {
    ...
    public SqlSessionFactory thirdSqlSessionFactory(@Qualifier("thirdData") DataSource dataSource) throws Exception {
        ...
        bean.setMapperLocations(new PathMatchingResourcePatternResolver().getResources("classpath*:com/dotop/smartwater/project/third/server/meterread/client3/dao/third/**/*.xml"));
